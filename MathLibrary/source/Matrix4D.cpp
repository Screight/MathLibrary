...
float Determinant(const Matrix4D& M) {
	return(
		-M[0][3] * Matrix3D::Determinant(Matrix3D((Vector3D)M[1], (Vector3D)M[2], (Vector3D)M[3]))
		+ M[1][3] * Matrix3D::Determinant(Matrix3D((Vector3D)M[0], (Vector3D)M[2], (Vector3D)M[3]))
		- M[2][3] * Matrix3D::Determinant(Matrix3D((Vector3D)M[0], (Vector3D)M[1], (Vector3D)M[3]))
		+ M[3][3] * Matrix3D::Determinant(Matrix3D((Vector3D)M[0], (Vector3D)M[1], (Vector3D)M[2]))
		);
}
